...
export default function StripeSetupPage() {
      ...
      <div className="pt-12 mb-6">
        <div className="wrapper">
          <h1 className="text-2xl sm:text-3xl tracking-tight font-extrabold mb-3">
            Firstly, connect your payment processor
          </h1>
        </div>
      </div>
      <div className="wrapper">
        <div className="rounded-lg bg-white max-w-2xl overflow-hidden border-2 border-gray-100 p-6">
          {
              ...
              <div>
                {
                  activeCompany?.payment_integration_type === 'manual' ? 
                    <>
                      <p className="text-lg mb-3">
                        <strong>
                          You are not currently using a payment processor.
                        </strong>
                        { ' ' }
                        Continue the setup process by clicking &quot;Next Step&quot;, or add a new payment integration by clicking &quot;Add a Payment Processor&quot;.
                      </p>
                      <div>
                        <Button
                  ...
                  : 
                    activeCompany?.payment_integration_type === 'stripe' ? 
                      <>
                        <p className="text-lg mb-3">
                          Your Stripe account is connected to Toppromoter.
                        </p>
                        <div className="mb-3">
                          ...
                          <p>
                            { activeCompany?.payment_integration_data?.settings?.dashboard?.display_name }
                          </p>
                        </div>
                        <div className="mb-8 pb-8 border-b-4">
                          ...
                          <p>
                            { activeCompany?.payment_integration_field_one }
                          </p>
                        </div>
                      </>
                        ...
                        <>
                          <div className="mb-8">
                            <h3 className="text-xl font-semibold mb-2">
                              Step 1. Enter your Paddle credentials:
                            </h3>
                            <div className="mt-4 space-y-4">
                              <div>
                                ...
                                <p className="mb-2">
                                  Your Public Key can be retrieved
                                  { ' ' }
                                  <a className="underline font-bold" href="https://vendors.paddle.com/public-key" target="_blank" rel="noreferrer">
                                    here.
                                  </a>
                                  { ' ' }
                                  Make sure to copy the entire key, including the beginning and end sections.
                                </p>
                                <div>
                                  <textarea
                                    required
  ...
  -----END PUBLIC KEY-----` }
                              ...
                              <div>
                                ...
                                <p className="mb-2">
                                  Your API Key can be retrieved
                                  { ' ' }
                                  <a className="underline font-bold" href="https://vendors.paddle.com/authentication" target="_blank" rel="noreferrer">
                                    here.
                                  </a>
                                  { ' ' }
                                  You may need to create a new key if one hasn&apos;t already been created.
                                </p>
                                <div>
                                  <input
                                    minLength="2"
                              ...
                              <div>
                                ...
                                <p className="mb-2">
                                  Your Vendor ID can be retrieved
                                  { ' ' }
                                  <a className="underline font-bold" href="https://vendors.paddle.com/authentication" target="_blank" rel="noreferrer">
                                    here
                                  </a>
                                  ...
                                  { ' ' }
                                  <strong>
                                    &ldquo;Your Paddle Vendor ID&ldquo;
                                  </strong>
                                </p>
                                <div>
                                  <input
                          ...
                          <div>
                            ...
                            <div className="mb-4">
                              <p className="mb-2">
                                In Paddle, go to
                                { ' ' }
                                <a target="_blank" rel="noreferrer" className="font-bold underline" href="https://vendors.paddle.com/alerts-webhooks">
                                  Developer tools &gt; Alerts / Webhooks
                                </a>
                                { ' ' }
                                and make sure the the following events have &ldquo;Webhook&ldquo; turned on:
                              </p>
                            ...
                            <div className="pb-6 border-b-4">
                              <p className="mb-2">
                                ...
                                { ' ' }
                                <strong>
                                  &ldquo;URLs for receiving webhooks&ldquo;
                                </strong>
                                { ' ' }
                      ...
                      <Button
                        ...
                        primary>
                        <span>
                          { loading ? `Connecting to ${altPayment}...` : `Connect to ${altPayment}` }
                        </span>
                      </Button>
                    </form>
                }
