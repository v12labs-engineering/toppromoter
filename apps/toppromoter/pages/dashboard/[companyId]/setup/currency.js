    ...
    <>
      ...
      <div className="wrapper">
        <div>
          {
            activeCompany ?
              <form className=" rounded-lg bg-white max-w-2xl overflow-hidden border-2 border-gray-100" action="#" method="POST" onSubmit={ handleSubmit }>
                <div className="p-6">
                  <div className="space-y-8 divide-y divide-gray-200">
                    <div>
                      <div>
                        <div>
                          <label htmlFor="company_currency" className="block text-sm font-bold text-gray-700">
                            Display currency
                          </label>
                          <div className="mt-1 flex rounded-md shadow-sm">
                            <select defaultValue={ activeCompany?.company_currency ? activeCompany?.company_currency : 'USD' } className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm focus:border-primary-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required="required" name="company_currency" id="company_currency">
                              <option value>
                                -- Select a currency --
                              </option>
